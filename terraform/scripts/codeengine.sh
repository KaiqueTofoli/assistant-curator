...
--env EXPERIMENTS_SKILLS_URL=$EXPERIMENTS_SKILLS_URL --env COGNOS_USERNAME=$COGNOS_USERNAME \
--env COGNOS_PASSWORD=$COGNOS_PASSWORD --env CLOUDANT_API_KEY=$CLOUDANT_API_KEY \
